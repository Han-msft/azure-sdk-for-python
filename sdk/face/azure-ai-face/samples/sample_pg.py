...
from azure.ai.face.models import PersonGroup, PersonGroupPerson, PersonGroupPersonFace
...
if __name__ == "__main__":
    ...
    operations = client.person_groups
    ...
    result = operations.create_group(gid, PersonGroup(name="my pg name"))
    print(result)

    result = operations.create_person(gid, PersonGroupPerson(name="person1"))
    print(result)
    ...
    result = operations.update_group(gid, PersonGroup(name="new name"))
    print(result)

    result = operations.get_group(gid)
    print(result)

    result = operations.update_person(gid, pid, PersonGroupPerson(name="new name"))
    print(result)

    result = operations.get_person(gid, pid)
    print(result)

    result = operations.update_face(gid, pid, face_id, PersonGroupPersonFace(user_data="new face data"))
    print(result)
    ...
    result = operations.identify_from_person_group(face_ids=fids, person_group_id=gid)
    print(result)

    result = operations.verify_from_person_group(face_id=fids[0], person_group_id=gid, person_id=pid)
    print(result)
