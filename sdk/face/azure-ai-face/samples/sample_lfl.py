...
from azure.ai.face.models import LargeFaceList, AddFaceFromUrlContent
...
if __name__ == "__main__":
    ...
    operations = client.large_face_lists
    ...
    result = operations.create_list(lid, LargeFaceList(name="my list name"))
    print(result)
    ...
    result = operations.update_list(lid, LargeFaceList(name="new name"))
    print(result)
    ...
    result = operations.find_similar_from_large_face_list(face_id=fid, large_face_list_id=lid)
    print(result)
