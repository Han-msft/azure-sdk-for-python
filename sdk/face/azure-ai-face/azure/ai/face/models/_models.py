...
class AccessoryItem(_model_base.Model):
    ...
    :ivar confidence: Confidence level of the accessory type. Required.
    ...
    """Confidence level of the accessory type. Required."""
...
class CompareFromStreamsContent(_model_base.Model):
    """Request body for compare operation.

    All required parameters must be populated in order to send to server.

    :ivar source: The source image to compare. Required.
    :vartype source: bytes
    :ivar target: The target image to compare. Required.
    :vartype target: bytes
    """

    source: FileType = rest_field(is_multipart_file_input=True)
    """The source image to compare. Required."""
    target: FileType = rest_field(is_multipart_file_input=True)
    """The target image to compare. Required."""
...
class CompareFromUrlAndStreamContent(_model_base.Model):
    """Request body for compare operation.

    All required parameters must be populated in order to send to server.

    :ivar source: The source image url to compare. Required.
    :vartype source: str
    :ivar target: The target image to compare. Required.
    :vartype target: bytes
    """
    ...
    """The source image url to compare. Required."""
    target: FileType = rest_field(is_multipart_file_input=True)
    """The target image to compare. Required."""
...
class CompareResult(_model_base.Model):
    """Response body for compare operation.

    All required parameters must be populated in order to send to server.

    :ivar source_image_face: Face in source image. Required.
    :vartype source_image_face: ~azure.ai.face.models.SourceImageFace
    :ivar target_image_face: Face in target image. Required.
    :vartype target_image_face: ~azure.ai.face.models.TargetImageFace
    :ivar detection_model: Detection model used for compare operation. Required. Known values are:
     "detection_01", "detection_02", and "detection_03".
    :vartype detection_model: str or ~azure.ai.face.models.DetectionModel
    :ivar recognition_model: Recognition model used for compare operation. Required. Known values
     are: "recognition_01", "recognition_02", "recognition_03", and "recognition_04".
    :vartype recognition_model: str or ~azure.ai.face.models.RecognitionModel
    """

    source_image_face: "_models.SourceImageFace" = rest_field(name="sourceImageFace")
    """Face in source image. Required."""
    target_image_face: "_models.TargetImageFace" = rest_field(name="targetImageFace")
    """Face in target image. Required."""
    detection_model: Union[str, "_models.DetectionModel"] = rest_field(name="detectionModel")
    """Detection model used for compare operation. Required. Known values are: \"detection_01\",
     \"detection_02\", and \"detection_03\"."""
    recognition_model: Union[str, "_models.RecognitionModel"] = rest_field(name="recognitionModel")
    """Recognition model used for compare operation. Required. Known values are: \"recognition_01\",
    ...
    def __init__(
        self,
        *,
        source_image_face: "_models.SourceImageFace",
        target_image_face: "_models.TargetImageFace",
        detection_model: Union[str, "_models.DetectionModel"],
...
class FindSimilarResult(_model_base.Model):
    ...
    :ivar confidence: Confidence value of the candidate. Required.
    :vartype confidence: float
    ...
    confidence: float = rest_field()
    """Confidence value of the candidate. Required."""
...
class HairColor(_model_base.Model):
    ...
    :ivar confidence: Confidence level of the color. Required.
    :vartype confidence: float
    """
    ...
    """Name of the hair color. Required. Known values are: \"unknown\", \"white\", \"gray\",
     \"blond\", \"brown\", \"red\", \"black\", and \"other\"."""
    confidence: float = rest_field()
    """Confidence level of the color. Required."""
...
class SourceImageFace(_model_base.Model):
    """Face in source image.

    All required parameters must be populated in order to send to server.

    :ivar face_rectangle: Rectangle area of the detected face. Required.
    :vartype face_rectangle: ~azure.ai.face.models.FaceRectangle
    :ivar face_landmarks: An array of 27-point face landmarks pointing to the important positions
     of face components. To return this, it requires 'returnFaceLandmarks' parameter to be true.
    :vartype face_landmarks: ~azure.ai.face.models.FaceLandmarks
    ...
    """Rectangle area of the detected face. Required."""
    face_landmarks: Optional["_models.FaceLandmarks"] = rest_field(name="faceLandmarks")
    """An array of 27-point face landmarks pointing to the important positions of face components. To
     return this, it requires 'returnFaceLandmarks' parameter to be true."""
    face_attributes: Optional["_models.FaceAttributes"] = rest_field(name="faceAttributes")
...
class TargetImageFace(_model_base.Model):
    """Face in target image.
